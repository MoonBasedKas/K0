...
k0: main.o lex.yy.o lex.o k0gram.tab.o tree.o dot.o
	$(CC) $(CFLAGS) $^ -o $@
...
zip: main.c lex.c lex.h tree.c tree.h k0gram.y kotlex.l Makefile README dot.c dot.h TestCases/*.kt dotOutputs/*.png
	zip -r lab5.zip $^